...
--
-- Host: localhost
-- Generation Time: Jul 27, 2023 at 01:17 PM
...
--
-- Database: `propounding_first_artificial_intelligence_approach`
--
CREATE DATABASE IF NOT EXISTS `propounding_first_artificial_intelligence_approach` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `propounding_first_artificial_intelligence_approach`;
...
('0do5eoneur3zqq9smt632bb37yd5hu97', 'eyJ1c2VyaWQiOjZ9:1qOw1m:bhlxO9yF0hXquC_sB3IHAyQrGqhs3x6KKWyTVsxs9xQ', '2023-08-10 08:07:18.410323'),
...
('20cqt5j49z7uciygvfga12oya50tgmqw', 'eyJ1c2VyaWQiOjF9:1od8pY:3hUamwFjiC0Cdolah2q8KkxeGSA-x3CBH46oXGRGsFI', '2022-10-11 11:32:52.540901'),
...
('4m1x3tjq3onlzfhp9g511pcyc7xl5m2p', 'eyJ1c2VyaWQiOjF9:1odWsU:t_-RKHuGkvwO49Md9MXEHp6iEeIE_OM_o0hAMeyYwMM', '2022-10-12 13:13:30.139454'),
...
('6jcpk7g6vqcxq6ylywwepqrhzafbm7id', 'eyJ1c2VyaWQiOjJ9:1od9vw:2yZ919IbWudadUkDxMRO-ixQowx6lMG3FE10T0ATjGw', '2022-10-11 12:43:32.459752'),
('6l3sphghiaaaayq43s1ci2xqdu4zs5rb', 'eyJ1c2VyaWQiOjV9:1qOvJA:YWgXdNK54afoTWSgXUnCnzc-05HtsE0sJXjrf1ZAwDw', '2023-08-10 07:21:12.732468'),
...
('eej4vrcmud5epd226r5tfe1t8t4iv0m9', 'eyJ1c2VyaWQiOjR9:1odo85:D5guoo_vXMatSt8-Hz1xeLwQsYIobSVJyjm_kyu5Uco', '2022-10-13 07:38:45.079392'),
...
(5, 'Amarnath', 'Amarnath123@gmail.com', 'Amarnath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(6, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(42, 'Convolution Neural Network-CNN', '48.125'),
(43, 'SVM', '50.0'),
(44, 'Logistic Regression', '51.24999999999999'),
(45, 'Decision Tree Classifier', '52.5');
...
(33, 'Robbery Mugging', '66.66666666666666'),
(34, 'Robbery Purse Snatch', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_robbery_behavior_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_robbery_behavior_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `event_unique_id` varchar(3000) NOT NULL,
  `occurrencedate` varchar(3000) NOT NULL,
  `reporteddate` varchar(3000) NOT NULL,
  `location_type` varchar(3000) NOT NULL,
  `premises_type` varchar(3000) NOT NULL,
  `Neighbourhood` varchar(3000) NOT NULL,
...
--
-- Dumping data for table `remote_user_robbery_behavior_detection`
--

INSERT INTO `remote_user_robbery_behavior_detection` (`id`, `Fid`, `event_unique_id`, `occurrencedate`, `reporteddate`, `location_type`, `premises_type`, `Neighbourhood`, `Longitude`, `Latitude`, `Prediction`) VALUES
(1, '172.217.10.227-10.42.0.211-443-40737-6', 'GO-20221629348', '2022/03/03 05:00:00+00', '2022/03/03 05:00:00+00', 'Streets, Roads, Highways (Bicycle Path, Private Road)', 'Outside', 'Victoria Village', '-79.30343034', '43.72668674', 'Robbery Purse Snatch'),
(2, '172.217.10.78-10.42.0.151-443-42200-6', 'GO-20221631807', '2022/03/03 05:00:00+00', '2022/03/03 05:00:00+00', 'Streets, Roads, Highways (Bicycle Path, Private Road)', 'Outside', 'Old East York', '-79.32874138', '43.69594155', 'Robbery Mugging'),
(3, '10.42.0.211-115.239.210.141-58262-443-6', 'GO-20221658878', '2022/03/07 05:00:00+00', '2022/03/07 05:00:00+00', 'Open Areas (Lakes, Parks, Rivers)', 'Outside', 'South Riverdale', '-79.33754387', '43.6687961', 'Robbery Mugging');
