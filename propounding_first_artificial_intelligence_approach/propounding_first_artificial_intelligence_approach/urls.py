"""propounding_first_artificial_intelligence_approach URL Configuration
...
from propounding_first_artificial_intelligence_approach import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Robbery_Behavior_Type/$', remoteuser.Predict_Robbery_Behavior_Type, name="Predict_Robbery_Behavior_Type"),
    ...
    url(r'^View_Robbery_Behavior_Detection_Ratio/$', serviceprovider.View_Robbery_Behavior_Detection_Ratio, name="View_Robbery_Behavior_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Robbery_Behavior_Detection_Type/$', serviceprovider.View_Robbery_Behavior_Detection_Type, name="View_Robbery_Behavior_Detection_Type"),
